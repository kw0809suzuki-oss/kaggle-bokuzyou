...
def main():
    ...
    out={
        "schema":"p1-wheat-prestate-deep-v0",
        "purpose":"deepen only the seven first-divergence WHEAT suppression packets: plant age/maturity/yield/water state",
    ...
    Path("p1_wheat_prestate_deep_v0.json").write_text(json.dumps(out,ensure_ascii=False,indent=2)+"\n",encoding="utf-8")
